              ...
              <div className="hero-image">
                <div className="image-container">
                  <img
                    ...
                    alt="Fortune Nnah - Frontend Developer"
                  />
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <ul>
                    ...
                    <li>
                      Collaborated with clients to translate design concepts
                      into functional interfaces
                    </li>
                    <li>
                      Maintained code quality through comprehensive testing and
                      code reviews
                    </li>
                  </ul>
                </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <ul>
                    ...
                    <li>
                      Contributed to team projects using version control systems
                    </li>
            ...
            <div className="education-grid">
              <div className="education-item">
                ...
                <div className="education-content">
                  ...
                  <p>
                    Focused on software engineering principles, algorithms, and
                    web technologies.
                  </p>
                </div>
              </div>
              ...
              <div className="education-item">
                ...
                <div className="education-content">
                  ...
                  <p>
                    Comprehensive training in React development, state
          ...
          <div className="container">
            ...
            <div className="values-grid">
              <div className="value-item">
                ...
                <h3>Innovation</h3>
                <p>
                  Constantly exploring cutting-edge technologies and creative
              ...
              <div className="value-item">
                ...
                <h3>Collaboration</h3>
                <p>
                  Building strong partnerships and working effectively with
